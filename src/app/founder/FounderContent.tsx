    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="mb-12 p-4 rounded-lg border border-brand-gold/20 bg-brand-gold/5 flex items-center justify-between">
          <div><p className="text-sm text-gray-300 font-medium">简历下载</p><p className="text-xs text-gray-500">吴涛 · 启元智能创始人</p></div>
          <a href="/resume.pdf" download className="px-4 py-2 rounded-lg bg-brand-gold/20 border border-brand-gold/30 text-brand-gold text-sm hover:bg-brand-gold/30 transition-colors">下载 PDF</a>
        </div>
        ...
        <article className="text-gray-300 leading-relaxed space-y-6">
          ...
          <ul className="space-y-1">
            <li className="ml-6 mb-1">AI Agent 组织设计：构建了 80+ 个 AI Agent Skill 的四层组织架构</li>
            ...
            <li className="ml-6 mb-1">财务BP实操：供应链 + 门店双线财务分析，预算编制→经营报告全流程</li>
            <li className="ml-6 mb-1">叙事设计：旗舰舰桥隐喻体系 / 伤痕叙事模式 / 矛盾场域头脑风暴法</li>
          </ul>
          ...
          <ul className="space-y-1">
            ...
            <li className="ml-6 mb-1">AI-Corp — 全栈企业智能平台，V1-V8 八个大版本</li>
